...
class OauthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \CuadraAiLib\Http\HttpRequest $request
     * @param \CuadraAiLib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \CuadraAiLib\Http\HttpRequest $request,
        \CuadraAiLib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \CuadraAiLib\Models\OauthProviderError::checkValue
     */
